...
никогда не записывает содержимое описания опыта в служебные файлы. Первый цикл
редактирования выполняется сразу после запуска, последующие — через заданный
интервал.
